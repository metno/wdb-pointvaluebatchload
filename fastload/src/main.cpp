...
int main(int argc, char ** argv)
{
	...
	fastload::old::OldTranslateJob translateJob(configuration.pqConnect(), configuration.wciUser(), configuration.nameSpace(), rawQue, translatedQue);
